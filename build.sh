...
# Ensure the functions directory exists in the build output
mkdir -p functions

# Copy the function handler file to the functions directory (if it's not already there)
cp functions/api.py functions/
